...
class TestHomework:  # noqa: PLR0904
    HOMEWORK_VERDICTS = {
    ...
    def test_homework_const(self, homework_module):
        ...
        assert homework_module.RETRY_PERIOD == self.RETRY_PERIOD, (
    ...
    def test_get_api_answer_with_request_exception(
        ...
        def mock_request_get_with_exception(*args, **kwargs):  # noqa: ARG001
            msg = 'Something wrong'
    ...
    def test_parse_status_with_expected_statuses(self, homework_module):
        ...
        for status_key in self.HOMEWORK_VERDICTS:
    ...
    def mock_main(
        ...
        *,
        ...
        def sleep_to_interrupt(secs):
            ...
            msg = 'break'
            raise utils.BreakInfiniteLoopError(msg)
    ...
    def test_main_send_message_with_new_status(
        ...
        with caplog.at_level(logging.WARNING):
            try:
                ...
                msg = f'Вызов функции `main` завершился ошибкой: {e}'
                raise AssertionError(msg) from e
